...
<div id="container"> 
    ...
    <p className="text">Un « cookie » est un fichier de données ou de textes que le serveur d’un site enregistre de manière temporaire ou permanente sur l’équipement de l’utilisateur (disque dur de l’ordinateur, tablette, smartphone ou tout autre appareil similaire) par l’intermédiaire de son navigateur (par exemple Internet Explorer).
    Les cookies peuvent aussi être installés par des tiers avec lesquels IN PACE collabore. Les cookies retiennent un certain nombre d’informations, comme par exemple les choix effectués par les visiteurs ou des statistiques relatives aux visiteurs du Site. Ces informations permettent par exemple de s’assurer que les applications du Site fonctionnent correctement ou encore d’adapter le contenu du Site en fonction du visiteur.
        </p>
